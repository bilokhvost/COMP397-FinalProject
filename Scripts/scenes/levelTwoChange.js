...
(function (scenes) {
    var LevelTwoChange = (function (_super) {
        ...
        LevelTwoChange.prototype.start = function () {
            ...
            this._highScoreLabel = new objects.Label(steakValue + " + " + friesValue + " + " + sauceValue + " = " + highScoreValue, "25px Consolas", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y + 25, true);
